...
I am indebted to the authors of the R Wiki Book (\url{https://en.wikibooks.org/wiki/R_Programming}), from which I took (in adapted form) some of the very basic introductory material about \software{R}.
In general, the statistics and \software{R} blogosphere and the \textit{CrossValidated} community have contributed significantly to my understanding of statistics and the \software{R} programming language.
